		...
		if(this.state.errorMessage){
			return (
				<div className='alert alert-danger' style={comStyles().errorMessage}>
					<strong>Oopse!</strong> {this.state.errorMessage}
				...
				<div style={comStyles().entrance}>
					...
					<form style={comStyles().form}>
						<div className='form-group'>
							...
							<input value={this.state.username} onChange={this.handleChange.bind(this, "username")} type="text" className='form-control' style={comStyles().formInput} />
						</div>
						<div className='form-group'>
